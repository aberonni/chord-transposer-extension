...
module.exports = function (grunt) {
  ...
  grunt.initConfig({
    ...
    sass: {
      ...
      dist: {
        files: {
          "<%= config.dist %>/styles/content.css":
            "<%= config.app %>/sass/content.scss",
          "<%= config.dist %>/styles/popup.css":
            "<%= config.app %>/sass/popup.scss",
        },
      },
    },
    ...
    concurrent: {
      tasks: ["sass", "imagemin", "svgmin", "concat", "copy"],
    },
  });

  grunt.registerTask("debug", function () {
    grunt.task.run(["clean", "concurrent", "watch"]);
  });

  grunt.registerTask("build", ["clean", "concurrent", "cssmin", "uglify"]);
};
